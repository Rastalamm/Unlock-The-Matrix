...
// function rotateTillEnd(layer){

  // var width = (layer * 2);
  // var numOfRotations = (width * 4) - 4;

//   for(var i = 0; i < numOfRotations; i++){
//     rotateMe.rotateStep('ClockWise', layer);
//     var postData = hexArray.toString();
//     postData = querystring.stringify({key:postData});
